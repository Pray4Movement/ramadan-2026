 ...
 *  "DT_R2026_Migration_xxxx", where xxxx is the migration number. For
 *  example:
 *
 *      class DT_R2026_Migration_0002 extends DT_R2026_Migration {
 *          // ...
 *      }
 *
 *  See the documentation for DT_Ramadan_2026_Migration_Engine.
 *
 */
abstract class DT_R2026_Migration {
    ...
    /**
     * @throws \DT_R2026_Migration_Test_Exception Table $name not as expected, see error log.
     */
    protected function test_expected_tables() {
        ...
        foreach ( $expected_tables as $name => $expected_table ) {
            ...
            if ( $got_table !== $expected_table ) {
                ...
                throw new DT_R2026_Migration_Test_Exception( "Table $name not as expected, see error log" );
            }
        }
    }
...
/**
 * Class DT_R2026_Migration_Test_Exception
 */
class DT_R2026_Migration_Test_Exception extends Exception {
}
